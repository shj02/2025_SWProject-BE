...
import com.mongletrip.mongletrip_backend.config.DelegatedAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .exceptionHandling(exec -> exec.authenticationEntryPoint(delegatedAuthenticationEntryPoint))
